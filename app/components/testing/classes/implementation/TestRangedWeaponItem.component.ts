...
import {TestDamage} from "./TestDamage.component";
/**
...
@Component({
    ...
    directives: [SpyDirective, TestDamage]
})
export class TestRangedWeaponItem extends AbstractTest implements OnInit, ITest<RangedWeaponItem> {
    ...
    test() {
        ...
        rangedWeaponItemBuilder.setDif(6)
            .setDamage(
                (new DamageBuilder()).setType(DamageType.Bashing).setValue(3).build()
